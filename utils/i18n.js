...
const DICT = {
  zh: {
    ...
    'settings.backupDownload': '生成下载链接',
    'settings.downloadLinkCopied': '链接已复制',
    'settings.downloadLinkFailed': '生成失败',
  ...
  en: {
    ...
    'settings.backupDownload': 'Create download link',
    'settings.downloadLinkCopied': 'Link copied',
    'settings.downloadLinkFailed': 'Create failed',
